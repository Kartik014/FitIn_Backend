...
import { createUser, deleteUser, getUser, getUserNamesAndEmails, logoutUser, updateUser } from "../controllers/user/user_controller.js";
...
apiRouter
    .route('/getUsernames')
    .get(xssClean(), getUserNamesAndEmails)
